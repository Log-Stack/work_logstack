"""
Django settings for work_logstack project.
...
ALLOWED_HOSTS = ['54.180.101.149', 'www.logstackdev.com', 'logstackdev.com', '172.31.35.107', '3.35.81.66',
                 ...
                 '3.35.99.185', 'logstackdev-179320874.ap-northeast-2.elb.amazonaws.com']
...
ROOT_URLCONF = 'work_logstack.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [os.path.join(BASE_DIR, 'work_logstack/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
